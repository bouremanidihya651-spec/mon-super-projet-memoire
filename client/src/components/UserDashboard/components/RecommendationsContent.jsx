// RecommendationsContent.jsx - VERSION TEST MINIMALE
import React, { useState, useEffect } from 'react';
import { Star, MapPin, ChevronRight, Heart, Search } from 'lucide-react';

// Test si les imports fonctionnent
console.log('Lucide icons loaded:', { Star, MapPin, ChevronRight, Heart, Search });
...
const RecommendationsContent = () => {
  ...
  useEffect(() => {
    // Données de test pour vérifier que le rendu fonctionne
    const testData = [
