...
const RecommendationCard = ({ destination, index, onViewDetails, openAuthModal, t }) => {
  ...
  return (
    ...
    >
      <div
        className="relative w-full h-[320px] sm:h-[380px] md:h-[420px] lg:h-[450px] rounded-2xl sm:rounded-3xl overflow-hidden cursor-pointer border border-stone-200 dark:border-dark-border hover:border-[#2d7a5a] transition-all duration-500 group touch-pan-y"
        ...
        <div className="absolute inset-0 p-3 sm:p-4 md:p-5 lg:p-6 flex flex-col justify-between">
          ...
          <div className="flex justify-between items-start gap-2">
            <div className="flex flex-col gap-1.5 sm:gap-2 max-w-[75%]">
              {matchPercentage > 0 && (
                <div className={`px-2 py-1 sm:px-3 sm:py-1.5 rounded-full font-bold text-[9px] sm:text-[10px] uppercase tracking-wider w-fit no-select ${
            ...
            <button
              ...
              className="w-9 h-9 sm:w-10 sm:h-10 min-w-[36px] min-h-[36px] rounded-full bg-black/40 backdrop-blur-md border border-white/20 flex items-center justify-center hover:bg-[#2d7a5a] hover:border-[#2d7a5a] transition-all group/btn active:scale-95 focus-ring no-select"
          ...
          <div className="space-y-2 sm:space-y-3">
            ...
            <div>
              <h3 className="text-lg sm:text-xl md:text-2xl font-serif font-bold text-white mb-1 sm:mb-2 leading-tight line-clamp-2">
                {destination.name}
              </h3>
            ...
            <button
              ...
              className="mt-1 sm:mt-2 px-4 py-2 sm:px-6 sm:py-3 bg-[#2d7a5a] text-white rounded-full font-bold text-[9px] sm:text-[10px] uppercase tracking-widest hover:bg-[#1a4a36] transition-all inline-flex items-center gap-1.5 sm:gap-2 min-h-[36px] sm:min-h-[44px] focus-ring no-select active:scale-95"
            >
...
const RecommendationsContent = ({ openAuthModal, t }) => {
  ...
  if (loading) {
    return (
      <div className="py-16 sm:py-20 text-center text-stone-500 animate-pulse px-4 ios-no-zoom">
