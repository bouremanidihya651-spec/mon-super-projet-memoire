...
const ResetPasswordPage = () => {
  ...
  const inputClass =
    `w-full ${isDark ? 'bg-[#1a2320] border-[#2d3a36] text-[#e8ece9]' : 'bg-white border-[#e0dcd4] text-[#1a4a36]'} border rounded-2xl py-3.5 px-4 pl-12 ${showPassword ? 'pr-12' : 'pr-4'} placeholder-[#9db8aa] focus:outline-none focus:ring-2 focus:ring-[#2d7a5a]/30 focus:border-[#2d7a5a] transition text-sm`;

  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '120px 24px 48px', fontFamily: "'DM Sans', sans-serif" }}>
